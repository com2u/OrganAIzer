-- File: /home/com2u/src/OrganAIzer/init-db/01-init.sql
-- Purpose: Complete database initialization for OrganAIzer Entry Management System
-- This script creates the complete database structure as specified in SQL DDL.sql

-- Create database and user
CREATE DATABASE organaizer;
CREATE USER comu2 WITH ENCRYPTED PASSWORD 'PPH2com2u';
ALTER USER comu2 CREATEDB;
GRANT ALL PRIVILEGES ON DATABASE organaizer TO comu2;

-- Connect to the organaizer database
\c organaizer;

-- Grant schema permissions
GRANT ALL ON SCHEMA public TO comu2;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO comu2;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO comu2;
...
-- Grant all permissions to comu2 user on all created tables
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO comu2;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO comu2;
